...
@Route(value = "/asyn_push")
public class AsynPushLogAction implements Action {

    private static final Logger logger = LoggerFactory.getLogger(AsynPushLogAction.class);
    ...
    public void doAction(final Request request, Response response) {
            ...
            // 设置返回信息：
            Integer httpCode = CodeManager.RESPONSE_CODE_NORMAL;
                ...
                Utils.executorService.submit(new Runnable() {
                    ...
                    public void run() {
                        try{
                            ...
                            KafkaLoggerFactory.getLogger(LogConfigManager.trashTopic).info(data);
                        }
                    }
                });
